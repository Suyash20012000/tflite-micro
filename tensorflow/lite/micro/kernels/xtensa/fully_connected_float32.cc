  ...
  for(int b = 0; b < num_batches; ++b) {
    TF_LITE_ENSURE_EQ(
        ...
        xa_nn_fully_connected_f32(
            (tflite::micro::GetTensorData<float>(output) + b * output_depth),
            tflite::micro::GetTensorData<float>(filter),
            (tflite::micro::GetTensorData<float>(input) + b * accum_depth),
...
TfLiteRegistration_V1 Register_FULLY_CONNECTED_FLOAT32() {
